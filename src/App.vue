...
const buttonDark = ref("bg-neutral-500 hover:bg-neutral-600 border-white ");
const buttonLight = ref("bg-white hover:bg-slate-100 border-black ");
...
const playAndPause = (param) => {
  ...
  if (isMusicPlaying.value) inputMusicRef.value.play();
...
<template>
  <div>
            ...
            >
              ...
              <div class="flex flex-row mt-5 md:justify-start justify-center">
                <button
                  ...
                  class="bg-teal-500 text-white font-bold p-2 pl-4 pr-4 mt-4 rounded-lg border hover:bg-black hover:text-white shadow-lg duration-100"
                >
                  Get started
                </button>
                <button
                  :class="darkMode ? 'border-white' : 'border-black'"
                  class="border p-2 pl-4 pr-4 mt-4 rounded-lg hover:bg-black hover:text-white ml-3 shadow-lg duration-100"
                ...
                :class="
                  selectedDifficulty
                    ? selectedDifficulty === difficulty.title
                      ...
                      : darkMode
                      ? buttonDark
                      : 'bg-gray-300 hover:bg-gray-400 border-black'
                    : difficulty.bg
                "
    ...
    <div :style="darkMode ? themeDark : ''" v-show="isPlaying">
      <div
        :class="darkMode ? 'bg-neutral-800' : 'bg-gray-400'"
        class="min-h-screen min-w-full flex flex-col items-center"
      >
        <!-- nav-Bar -->
        <div
          :class="
            darkMode ? 'bg-neutral-700 border-white' : 'bg-white border-black'
          "
        ...
        >
          ...
          <div
            :class="
              darkMode ? 'bg-neutral-500 border-white' : 'bg-white border-black'
            "
          ...
          <div class="flex mt-7 justify-center">
            <button
              :class="
                darkMode
                  ? 'bg-neutral-500 border-white hover:bg-neutral-600 fill-white'
        ...
        <!-- REF -->
        <div
          :class="darkMode ? 'bg-neutral-700' : 'bg-slate-300 border-black'"
        ...
        ></div>
        <div
          :class="darkMode ? 'bg-neutral-700' : 'bg-white border-black'"
          class="flex flex-col w-[calc(100%-2.5rem)] max-w-[32em] border text-center rounded-3xl p-8 py-5 items-center absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2"
          v-show="isFinish"
        >
          ...
          <!-- circle-score -->
          <div
            :class="darkMode ? 'bg-neutral-500' : 'bg-gray-300 border-black'"
